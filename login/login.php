...
<body>
    ...
    <main role="main">
        ...
        <form name="frmdangnhap" id="frmdangnhap" method="post" action="index.php?act=login">
                        ...
                        <div class="card-group">
                            <div class="card p-4">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <button class="btn btn-primary px-4" name="login">Đăng nhập</button>
                                        </div>
                            ...
                            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
                                <div class="card-body text-center">
                                    <div>
                                        ...
                                        <a class="btn btn-primary active mt-3" href="index.php?act=dangki">Đăng ký ngay!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
